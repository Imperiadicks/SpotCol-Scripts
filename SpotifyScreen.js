...
fetchWiki = async function(artist) {
...
function buildPrompt(artist, track) {
  ...
  return [
    ...
    'Для каждой секции дай 10–20 предложений.',
    '',
    '=== Артист ===',
    artSafe,
    '',
...
// … тут идёт твоя уже рабочая IIFE для отображения интерфейса
// (я не копирую заново, ты её оставляешь как есть)
